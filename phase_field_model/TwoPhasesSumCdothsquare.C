...
validParams<TwoPhasesSumCdothsquare>()
{
  ...
  params.addRequiredParam<MaterialPropertyName>("h1_name","Switching function of fcc");
  params.addRequiredParam<MaterialPropertyName>("h2_name","Switching function of imc1");
